...
* **Construction**: Run [hccexplorer_graph_construction.ipynb](https://github.com/MedCAI/HCC/blob/main/GraphLearning/Tutorial_hccexplorer_graph_construction.ipynb) to generate super patches and build the graph structure.
* **Visualization**: Run [hccexplorer_graph_visualization.ipynb](https://github.com/MedCAI/HCC/blob/main/GraphLearning/Tutorial_hccexplorer_graph_visualization.ipynb) to inspect the generated graphs and attention maps.
