...
def combine_multichannel_patches_tilewise(
    ...
    wsi_width,
    wsi_height,
    save_path="multi_output.tiff",
    tile_size=2048,
    patch_size=512,
    overlap=128,  # 新增 Overlap 参数
):
    num_channels = 8
...
if __name__ == "__main__":
    ...
    wsi_root = '/data/ceiling/workspace/HCC/Registration/HE/'
    name = '201429858.3.ome'
    wsi_path = os.path.join(wsi_root, name + '.tiff')

    slide = openslide.OpenSlide(wsi_path)
    wsi_width, wsi_height = slide.dimensions

    patch_dirs = [
        './convert_images/HE2Foxp3_512/val_latest/images/fake_B/',
        './convert_images/HE2CD19_512/val_latest/images/fake_B/',
        './convert_images/HE2CD68_512/val_latest/images/fake_B/',
        './convert_images/HE2CD4_512/val_latest/images/fake_B/',
        './convert_images/HE2CD3_512/val_latest/images/fake_B/',
        './convert_images/HE2CD8_512/val_latest/images/fake_B/',
    ]

    save_path = os.path.join('./convert_images/temp_save/', name + '.tiff')
